...
public class Edit extends JPanel {
	...
	public Edit() {
		...
		updateB.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				System.out.println("Ware House Edit Update");
				String sql = "UPDATE item SET name='" + nameF.getText().trim() + "',cid='"
						...
						+ codeF.getText().trim() + "'";
				String wsql = "UPDATE warehouse SET countNumber='" + quantiF.getText().trim() + "',buyPrice='"
		...
		deleteB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String wsql = "DELETE FROM warehouse WHERE id='" + codeF.getText().trim() + "'";
					Connection c = db.getConnection();
					Statement stmt = c.createStatement();
					int i = stmt.executeUpdate(sql);
					int k=stmt.executeUpdate(wsql);
	...
	public void loadData() {
		try {
			String sql = "SELECT * FROM item i,warehouse w where i.id='" + codeF.getText().trim() + "'";
			try {
				Connection c = db.getConnection();
				Statement stmt = c.createStatement();
				ResultSet rs = stmt.executeQuery(sql);
				while (rs.next()) {
					...
					bPriceF.setText("" + rs.getDouble("buyPrice"));
